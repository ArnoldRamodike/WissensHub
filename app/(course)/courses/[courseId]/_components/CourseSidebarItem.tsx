...
const CourseSidebarItem = ({courseId, id, isCompleted, isLocked, label}: CourseSidebarItemProps) => {
  ...
  return (
    <Button 
        ...
        isActive && "text-slate-700 bg-sky-200/20 hover:bg-slate-200/20 hover:text-slate-700 ",
        ...
        <div className={cn('ml-auto opacity-0 border-2 bg-slate-700 h-full transition-all')}/>
    </Button>
  )
}
