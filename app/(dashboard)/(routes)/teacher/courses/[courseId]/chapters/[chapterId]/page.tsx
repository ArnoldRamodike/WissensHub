...
const ChapterIdPage = async ({params}: {params: {courseId: string, chapterId: string}}) => {
    ...
    const comeptedFields = requredFields.filter(Boolean).length;

    const completionText = `(${comeptedFields}/${totalFields})`
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
            <div className="space-y-4">
              ...
              <div className="">
                ...
                <ChapterAcessForm initialData={chapter} courseId={params.courseId} chapterId={params.chapterId}/>
              </div>
            </div>
